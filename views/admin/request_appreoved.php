                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Request Member Data</h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        foreach ($list as $lists){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../process/data-process.php?user_no=<?php echo $lists->no; ?>" class="btn-sm btn-success"><i class="fas fa-check-square"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
