    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            <div class="user-panel mt-5 pb-3 mb-3 d-flex">
                <div class="image">
                    <img style="width: 3.1rem; height: 3.1rem" src="../../assets/img/c.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info mt-2">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <?php if($userdetails->checkActive == 'no') { ?>
                    <li class="nav-item">
                        <a href="price_table.php" class="nav-link ">
                    ...
                    <li class="nav-item">
                        <a href="instructing_offere.php" class="nav-link ">
                            <i class="nav-icon fas fa-edit"></i>
                            <p>
                                Add Instructing Offer
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="instructing_info.php" class="nav-link ">
                            <i class="nav-icon fab fa-battle-net"></i>
                            <p>
                                Instructing Institue Info
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
